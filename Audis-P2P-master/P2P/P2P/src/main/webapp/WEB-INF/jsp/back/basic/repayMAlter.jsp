			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form id="demo-form2" class="form-horizontal form-label-left"
						action="doRepayMAlter" name="repaymentmethods">
						<input type="hidden" name="id" value="${repaymentmethods.id }">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="repaymentmethods" required="required"
									...
									value="${repaymentmethods.repaymentmethods }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="identifiers" required="required"
									...
									value="${repaymentmethods.identifiers }">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="algorithminformation" required="required"
									...
									value="${repaymentmethods.algorithminformation }">
							</div>
						</div>
