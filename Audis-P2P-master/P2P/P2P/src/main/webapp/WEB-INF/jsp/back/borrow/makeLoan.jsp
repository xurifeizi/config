		...
		<div class="x_panel">
			...
			<div class="x_content">
					...
					<tbody>
						<c:forEach items="${borrowmarks }" var="borrowmark">
							<tr>
								...
								<td>
									<button type="button" b_id="${borrowmark.id }"
										class="btn btn-round btn-danger makeLoan">放款</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
				...
				<script type="text/javascript">
					//分页
					function page(num) {
						window.location.href = "goMakeLoan?currentPageNo=" + num;
					}
				</script>
