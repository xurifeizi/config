...
<div class="x_panel">
	<div class="x_title">
		<h2 style="width: 200px">
			我的融资&nbsp;&nbsp;&nbsp; <a type="button"
				...
				href="${pageContext.request.contextPath }/front/loan/goLoan">我要融资</a>
		</h2>
	...
	<div class="x_content">
			...
			<tbody>
				<c:forEach items="${borrowmarks }" var="borrowmark">
					<tr>
						...
						<td><c:if
								test="${borrowmark.status ==3 || borrowmark.status ==1}">
		...
		<script type="text/javascript">
			//分页
			function page(num) {
				window.location.href = "goMyLoan?currentPageNo=" + num;
			}
		</script>
