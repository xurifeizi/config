			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form id="demo-form2" class="form-horizontal form-label-left"
						action="doAdminAlter" name="member_">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="password" id="paymentpassword" required="required"
									class="form-control col-md-7 col-xs-12"
									value="${member.paymentpassword }" name="paymentpassword">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12"
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select class="form-control col-md-7 col-xs-12" id="r_id"
									name="r_id">
									<c:forEach items="${roles }" var="role">
										<c:if test="${role.id == member.r_id }">
